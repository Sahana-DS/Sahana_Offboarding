...
// Middleware
app.use(cors({
  origin: ['http://13.60.228.159:3000', 'http://13.60.228.159'],
...
pool.connect()
  .then(() => {
    ...
    initializeDatabase().then(() => {
      app.listen(port, () => {
        console.log(`🚀 Server running on http://13.60.228.159:${port}`);
        console.log(`📄 Offboarding Form: http://13.60.228.159:${port}/offboarding.html`);
        console.log(`📊 HR Offboarding Dashboard: http://13.60.228.159:${port}/hrOffboarding.html`);
      });
    });
  })
  .catch(err => {
